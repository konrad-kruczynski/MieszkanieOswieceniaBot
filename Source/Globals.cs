...
namespace MieszkanieOswieceniaBot
{
    internal static class Globals
    {
        ...
        public static readonly Scenario[] Scenarios =
        {
            ...
            new Scenario(BasicRange, new [] { 1, 2, 11 }, new Dictionary<int, int> { { 2, 50 } }),
            new Scenario(BasicRange, new [] { 2, 11 }, new Dictionary<int, int> { { 2, 35 } }),
            new Scenario(BasicRange, new [] { 2 }, new Dictionary<int, int> { { 2, 21 } }),
